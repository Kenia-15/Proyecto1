...
namespace aplicacion_proyecto1.Controllers
{
    public class PersonasController : Controller
    {
        ...
        public PersonasController(p_busesContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("IdPersona,IdMetodoPago,NumeroIdentificacion,PrimerNombre,SegundoNombre,PrimerApellido,SegundoApellido")] TblPersona tblPersona)
        {
        ...
        {
          return (_context.TblPersonas?.Any(e => e.IdPersona == id)).GetValueOrDefault();
        }
    }
}
